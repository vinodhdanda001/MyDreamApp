using TrackMyKid.NotificationManager.Exceptions;
using TrackMyKid.NotificationManager.Serialization;
using System;
...
namespace TrackMyKid.NotificationManager.PushNotifications
{
    /// <summary>
    /// 
    /// </summary>
